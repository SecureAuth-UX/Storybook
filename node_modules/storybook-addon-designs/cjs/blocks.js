...
var components_2 = require("@storybook/components");
...
exports.DocBlockBase = function (_a) {
    ...
    return (theming_1.jsx(components_2.components.resetwrapper, null,
...
exports.Figspec = function (_a) {
    var placeholder = _a.placeholder, props = __rest(_a, ["placeholder"]);
    console.warn("🚨 `Figspec` block is currently experimental and requires you to include your figma's access token in your storybook build, use with caution!");
    return (theming_1.jsx(exports.DocBlockBase, __assign({ placeholder: placeholder !== null && placeholder !== void 0 ? placeholder : 'Design (Figma-Spec)' }, props),
        theming_1.jsx(Figspec_1.Figspec, { config: __assign({ type: 'experimental-figspec' }, props) })));
};
